  ...
  <section class="site-section">
    <form class="form" @submit.prevent="handleLogin">
      <div class="form-control">
        ...
        <input v-model="username" type="text" id="username" name="username" class="form-input"
          placeholder="Enter your username" />
      </div>
      <div class="form-control">
        <label for="password">Password</label>
        <input v-model="password" type="password" id="password" name="password" class="form-input"
